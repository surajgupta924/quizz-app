...
export default function Profile() {
  ...
  const [form, setForm] = useState({ name: user.name, gender: user.gender, college: user.college || '', course: user.course || '', year: user.year || '', dob: user.dob ? new Date(user.dob).toISOString().slice(0, 10) : '' });
